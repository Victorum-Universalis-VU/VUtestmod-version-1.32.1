...
NCountry = {
	...
	PS_MAKE_PROVINCE_CORE = 3,                      -- Decreased this to 3 from 5
	...
	OVEREXTENSION_FACTOR = 0.5,                     -- Decreased this to 0.4 from 0.5
...
NMilitary = {
	...
	SUPPLYLIMIT_BASE_MULTIPLIER = 10, 				-- Increased this to 10 from 4 Keeping low so it's actually important to warfare, gives smaller nations chance against blobs and reduces doomstacks early game
