...
NCountry = {
	...
	PS_MAKE_PROVINCE_CORE = 3.5,                      -- Decreased this to 3.5 from 5, don't go lower because stacking ccr bonuses from ideas and modifiers may make it OP
...
NMilitary = {
	...
	SUPPLYLIMIT_BASE_MULTIPLIER = 5, 				-- Keeping low so it's actually important to warfare, gives smaller nations chance against blobs and reduces doomstacks early game. Also discovered high value makes random provinces start with absurd SL
	...
	INF_SUPPRESSION = 0.4,						-- Increased this to 0.4 from 0.25 The amount of reduction to unrest for each friendly infantry regiment in a province
	CAV_SUPPRESSION = 0.4,						-- Increased this to 0.4 from 0.25 The amount of reduction to unrest for each friendly cavalry regiment in a province
	ART_SUPPRESSION = 0.4,						-- Increased this to 0.4 from 0.25 The amount of reduction to unrest for each friendly artillery regiment in a province
...
NAI = {
	...
	CHARTER_COMPANY_DEVELOPMENT_RELUCTANCE_MULTIPLIER = 1,				-- How much development needed to add one reluctance
