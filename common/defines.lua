...
NCountry = {
	...
	PS_MAKE_PROVINCE_CORE = 4,                      -- Decreased this to 4 from 5, don't go lower because stacking ccr bonuses from ideas and modifiers may make it OP
...
NMilitary = {
	...
	SUPPLYLIMIT_BASE_MULTIPLIER = 4, 				-- Keeping low so it's actually important to warfare, gives smaller nations chance against blobs and reduces doomstacks early game. Also discovered high value makes random provinces start with absurd SL
